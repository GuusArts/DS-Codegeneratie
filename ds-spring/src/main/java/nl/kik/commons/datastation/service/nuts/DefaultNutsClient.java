...
import nl.kik.commons.datastation.dto.nuts.credential.CreateDID;
...
public class DefaultNutsClient implements NutsNode {
	...
	@Override
	public NutsDIDDocument createDID(CreateDID body) {
		return requireResponse(internalNutsRestClient.postForEntity(url("internal/vdr/v1/did", Map.of()), body,
				NutsDIDDocument.class));
	}
	...
	@Override
	public AccessToken requestAccessToken(CreateJwtGrant body) {
		return requireResponse(internalNutsRestClient
				.postForEntity(url("internal/auth/v1/request-access-token", Map.of()), body, AccessToken.class));
	}
