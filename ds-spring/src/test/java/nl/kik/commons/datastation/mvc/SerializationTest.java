...
//				.andDo(print()) //
		...
		result = mockMvc.perform(MockMvcRequestBuilders.post("/didcomm/pass").content(request)
				.contentType(MediaType.APPLICATION_JSON)) //
//				.andDo(print()) //
				.andExpect(MockMvcResultMatchers.status().isOk()) //
				.andReturn();
...
//				.andDo(print()) //
		...
		result = mockMvc.perform(MockMvcRequestBuilders.post("/didcomm/error").content(request)
				.contentType(MediaType.APPLICATION_JSON)) //
//				.andDo(print()) //
				.andExpect(MockMvcResultMatchers.status().isOk()) //
				.andReturn();
