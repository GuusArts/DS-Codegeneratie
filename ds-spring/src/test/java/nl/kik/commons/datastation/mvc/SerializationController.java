...
public class SerializationController {
	...
	public Request request(@RequestBody Request create) {
		...
		log.info("Request.body {}", create.getBody());
		log.info("Request.body.vp {}", create.getBody().getVp());
		log.info("Request.body.credentialSubject {}", create.getBody().getCredentialSubject());
		return create;
	}
